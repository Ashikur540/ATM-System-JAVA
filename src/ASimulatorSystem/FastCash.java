...
public class FastCash extends JFrame implements ActionListener {
    ...
    FastCash(String pin) {
        ...
        l1.setBounds(150, 338, 600, 35);
        l3.add(l1);

//        b1.setBounds(170, 499, 150, 35);
//        l3.add(b1);
        b1.setBounds(150, 379, 150, 35);
        l3.add(b1);
//
//        b2.setBounds(390, 499, 150, 35);
//        l3.add(b2);
        b2.setBounds(150, 417, 150, 35);
        l3.add(b2);
//
//        b3.setBounds(170, 543, 150, 35);
//        l3.add(b3);
            b3.setBounds(150, 459, 150, 35);
            l3.add(b3);
//
//        b4.setBounds(390, 543, 150, 35);
//        l3.add(b4);
        b4.setBounds(310, 378, 150, 35);
        l3.add(b4);
//
//        b5.setBounds(170, 588, 150, 35);
//        l3.add(b5);
//        
        b5.setBounds(310,417,145,35);
        l3.add(b5);
//
//        b6.setBounds(390, 588, 150, 35);
//        l3.add(b6);
        b6.setBounds(310,459,145,35);
        l3.add(b6);
